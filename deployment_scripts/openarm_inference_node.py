...
class DextrahFGPNode(Node):
    def __init__(self, node_name: str) -> None:
        ...
        self._left_tcp_pose_command_pub = self.create_publisher(JointState, '/left_tcp_pose_commands', 1)
...
#            1)
    ...
    def init_fgp(self):
        ...
        student_ckpt = "distillation/runs/Openarm_19-13-27-25/nn/dextrah_student_90000_iters.pth"
...
#        cv2.waitKey(1)
    ...
    def _left_tcp_pose_pub_callback(self):
        ...
        if left_tcp_pose_targets is not None:
            ...
            msg.position = left_tcp_pose_targets.tolist()
            msg.velocity = []
            msg.effort = []
