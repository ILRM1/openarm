...
openarm_usd_path = os.path.join(root_path, "openarm/openarm_tether_flat.usd")

OPEN_ARM_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=openarm_usd_path,
    ...
    actuators={
        "openarm_arm": ImplicitActuatorCfg(
            joint_names_expr=[
                "openarm_left_joint[1-6]",
                "openarm_right_joint[1-6]",
            ],
            velocity_limit_sim={
                "openarm_left_joint[1-2]": 8.0,
                "openarm_right_joint[1-2]": 8.0,
                "openarm_left_joint[3-4]": 5.445,
                "openarm_right_joint[3-4]": 5.445,
                "openarm_left_joint[5-6]": 8.0,
                "openarm_right_joint[5-6]": 8.0,
            },
            effort_limit_sim={
                ...
                "openarm_left_joint[5-6]": 7.0,
                "openarm_right_joint[5-6]": 7.0,
            },
            stiffness=80.0,
            damping=4.0,
        ),
