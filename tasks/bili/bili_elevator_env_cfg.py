...
import warp as wp
import math
from dextrah_lab.assets.bili.bili_aero import BILI_ARM_CFG, BILI_ARM_HIGH_PD_CFG
...
@configclass
class BiliElevatorEnvCfg(DirectRLEnvCfg):
    # Placeholder for objects_dir which targets the directory of objects for training
    objects_dir = "ev_button"
    valid_objects_dir = ["ev_button"]
    ...
    # robot
    robot_cfg: ArticulationCfg = BILI_ARM_HIGH_PD_CFG.replace(prim_path="/World/envs/env_.*/Robot").replace(
    ...
    left_arm_joint_name = [
            "joint_6_ARM_LEFT_A", "joint_7_ARM_LEFT_B", "joint_8_ARM_LEFT_C",
            "joint_9_ARM_LEFT_D", "joint_10_ARM_LEFT_E", "joint_11_ARM_LEFT_G", "joint_12_HANDLE_LEFT"
    ]
    right_arm_joint_name = [
        "joint_13_ARM_RIGHT_A", "joint_14_ARM_RIGHT_B", "joint_15_ARM_RIGHT_C",
        "joint_16_ARM_RIGHT_D", "joint_17_ARM_RIGHT_E", "joint_18_ARM_RIGHT_G", "joint_19_HANDLE_RIGHT"
    ]
    ...
    left_tcp_name = "bili_left_ee_tcp"
    right_tcp_name = "bili_right_ee_tcp"

    leg_joint_name = ["joint_2_LEG_A", "joint_1_LEG_C"]
    head_joint_name = ["joint_5_HEAD_A"]
    body_joint_name = ["joint_3_BODY_A1_1"]
    ...
    head_cam_cfg = TiledCameraCfg(
        prim_path="/World/envs/env_.*/Robot/HAED_As_Link/Camera",
    ...
    right_index_tip_contact_sensor_cfg = ContactSensorCfg(
